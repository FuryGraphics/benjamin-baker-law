...
export default function AttorneyIntro({ isFullPage = false, setRoute }: AttorneyIntroProps) {
  ...
  if (isFullPage) {
    return (
      <main className="bg-[#0C0C0C] min-h-screen pt-32 pb-24 px-5 sm:px-6 lg:px-8 relative" id="attorney-full-page">
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          <div className="text-center mb-16">
            ...
            <p className="font-sans text-xs tracking-widest text-[#888880] uppercase mt-2">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
            ...
            <div className="lg:col-span-5 space-y-6">
              <div className="relative aspect-[4/5] bg-[#141414] border border-[#C9A84C]/30 rounded-sm p-6 flex flex-col justify-between shadow-2xl overflow-hidden">
                ...
                <div className="text-center pb-4 border-t border-white/[0.04] pt-4">
                  <p className="font-sans text-[11px] text-[#E8D08A] tracking-wider uppercase font-semibold">
                    Benjamin A. Baker P.C.
                  </p>
                  <p className="font-sans text-[10px] text-[#888880] tracking-wide mt-1">
              ...
              <div className="bg-[#141414] border border-[rgba(201,168,76,0.12)] p-6 space-y-4">
                <div className="flex items-center space-x-3 text-xs">
                  <ShieldCheck className="w-5 h-5 text-[#C9A84C] shrink-0" />
                  <span className="text-[#F2EDE4] font-medium tracking-wide">Licensed Texas Attorney (Active)</span>
                </div>
                <div className="flex items-center space-x-3 text-xs">
                  <Award className="w-5 h-5 text-[#C9A84C] shrink-0" />
                  <span className="text-[#F2EDE4] font-medium tracking-wide">Trial Lawyers Association Member</span>
                </div>
                <div className="flex items-center space-x-3 text-xs">
                  <Briefcase className="w-5 h-5 text-[#C9A84C] shrink-0" />
                  <span className="text-[#F2EDE4] font-medium tracking-wide">Over 20 Years Active Service</span>
                </div>
              </div>
            </div>

            {/* Right Column: In-depth Biography CV */}
            <div className="lg:col-span-7 space-y-8 text-[#F2EDE4]/90 pr-2">
              <div className="space-y-4">
                <span className="font-sans text-xs text-[#C9A84C] tracking-[4px] uppercase block font-semibold">
                  Founder & Principal Counsel
                </span>
                <h2 className="font-serif text-3xl sm:text-4xl text-[#E8D08A] font-medium">
                  Straightforward Advisories, Aggressive Client Representation
                </h2>
              </div>

              <div className="font-sans text-xs sm:text-sm text-[#888880] leading-relaxed space-y-6">
                <p className="text-[#F2EDE4]/80 text-base leading-relaxed">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 pt-6 border-t border-white/[0.04]">
                <div className="space-y-4">
                  ...
                  <ul className="space-y-3 font-sans text-xs leading-relaxed text-[#888880]">
                    <li>
                      <strong className="text-[#F2EDE4] block">Juris Doctor (J.D.)</strong>
                      South Texas College of Law — Houston, TX
                    </li>
                    <li>
                      <strong className="text-[#F2EDE4] block">Bachelor of Science (B.S.)</strong>
              ...
              <div className="bg-[#141414] p-8 border border-[rgba(201,168,76,0.18)] space-y-6">
                <h3 className="font-serif text-xl text-[#E8D08A] font-semibold tracking-wide">Core Principles of the Firm</h3>
              ...
              <div className="pt-4 flex justify-end">
                <button
                  ...
                  className="bg-[#C9A84C] hover:bg-[#E8D08A] text-[#0C0C0C] font-sans text-xs font-bold tracking-widest uppercase py-4 px-8 transition-colors cursor-pointer"
  ...
  return (
    <section 
      className="bg-[#141414] py-24 px-5 sm:px-6 lg:px-8 border-b border-[rgba(201,168,76,0.12)] relative"
      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-5 flex justify-center lg:justify-start" id="meet-attorney-left">
            <div className="relative w-full max-w-sm aspect-[4/5] bg-[#0C0C0C] border border-[#C9A84C]/25 rounded-sm p-6 flex flex-col justify-between shadow-2xl overflow-hidden animate-pulse-slow">
              ...
              <div className="text-center pb-4 border-t border-white/[0.04] pt-4">
                <p className="font-sans text-[11px] text-[#F2EDE4]/90 tracking-wide font-medium">
                  Grayson County Courthouse Advocate
                </p>
                <p className="font-sans text-[9px] text-[#888880] tracking-wide mt-1">
          ...
          <div className="lg:col-span-7 space-y-8" id="meet-attorney-right">
            <div className="space-y-4">
              <span className="font-sans text-xs tracking-[6px] text-[#888880] uppercase block font-semibold">
                Meet Your Attorney
              </span>
              <h2 id="attorney-intro-title" className="font-serif text-3xl sm:text-4xl text-[#F2EDE4] font-medium leading-tight">
                Benjamin A. Baker — Straightforward Counsel, Aggressive Advocacy.
              </h2>
            </div>

            <p className="font-sans text-xs sm:text-sm text-[#888880] leading-relaxed">
              Benjamin A. Baker has built his practice on a simple belief: every client deserves honest advice and fierce representation. Located in the heart of Sherman, Texas, Mr. Baker brings decades of experience to family law, personal injury, civil litigation, and employment matters across Grayson County. He takes time to understand your situation — then fights to protect what matters most to you.
            </p>

            {/* Stat Pills */}
            <div className="flex flex-wrap gap-4 pt-2">
              <div className="border border-[#C9A84C]/30 bg-black/20 text-[#E8D08A] font-sans text-xs tracking-wider font-semibold uppercase py-2.5 px-5 rounded-full flex items-center space-x-2">
            ...
            <div className="pt-4">
              <button
                ...
                className="group inline-flex items-center space-x-2 text-[#C9A84C] hover:text-[#E8D08A] font-sans text-xs font-bold uppercase tracking-widest cursor-pointer focus:outline-none"
