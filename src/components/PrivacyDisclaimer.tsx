...
export default function PrivacyDisclaimer({ mode, setRoute }: PrivacyDisclaimerProps) {
  ...
  return (
    <main className="bg-[#0C0C0C] min-h-screen pt-32 pb-24 px-5 sm:px-6 lg:px-8 relative" id="privacy-disclaimer-subpage">
      ...
      <div className="max-w-4xl mx-auto relative z-10 space-y-8">
        {mode === 'privacy' ? (
          ...
          <div className="space-y-6" id="privacy-policy-view">
            <div className="flex items-center space-x-3 text-[#C9A84C] mb-4">
              ...
              <h1 className="font-serif text-3xl sm:text-4xl text-[#F2EDE4] font-medium tracking-tight">
                Privacy Policy
              </h1>
            </div>
            
            <p className="font-sans text-xs text-[#888880] uppercase tracking-widest block border-b border-white/[0.04] pb-4">
              LAST UPDATED: MAY 23, 2026 • BENJAMIN A. BAKER P.C.
            </p>

            <div className="font-sans text-xs sm:text-sm text-[#888880]/90 leading-relaxed space-y-6">
              <p>
              ...
              <div>
                <h2 className="font-serif text-lg text-[#E8D08A] font-medium tracking-wide mb-2">1. Information We Collect</h2>
                <p>
              ...
              <div>
                <h2 className="font-serif text-lg text-[#E8D08A] font-medium tracking-wide mb-2">2. How We Protect Submitted Case Details</h2>
                <p>
              ...
              <div>
                <h2 className="font-serif text-lg text-[#E8D08A] font-medium tracking-wide mb-2">3. Non-Disclosure Commitment</h2>
                <p>
              ...
              <div>
                <h2 className="font-serif text-lg text-[#E8D08A] font-medium tracking-wide mb-2">4. Digital Cookies</h2>
                <p>
          ...
          <div className="space-y-6" id="attorney-disclaimer-view">
            ...
            <div className="font-sans text-xs sm:text-sm text-[#888880]/90 leading-relaxed space-y-6">
              ...
              <div className="border border-[#C9A84C]/25 bg-black/30 p-6 rounded-sm space-y-3">
                <h2 className="font-serif text-lg text-[#E8D08A] font-semibold tracking-wide">No Attorney-Client Connection Confirmed</h2>
                <p className="text-xs">
              ...
              <div>
                <h2 className="font-serif text-lg text-[#E8D08A] font-medium tracking-wide mb-2">Not Substitute of Counsel</h2>
                <p>
              ...
              <div>
                <h2 className="font-serif text-lg text-[#E8D08A] font-medium tracking-wide mb-2">Texas Advertising Rules</h2>
                <p>
              ...
              <div>
                <h2 className="font-serif text-lg text-[#E8D08A] font-medium tracking-wide mb-2">Third-Party Coordinates</h2>
                <p>
        ...
        <div className="pt-12 border-t border-[#C9A84C]/15 flex flex-col sm:flex-row items-center justify-between gap-6">
          <div className="text-center sm:text-left">
            <h3 className="font-serif text-lg text-[#E8D08A] font-medium">Have an active legal inquiry?</h3>
            <p className="font-sans text-xs text-[#888880] mt-1">Get straightforward advisory evaluation blocks today.</p>
          </div>
          <button
            onClick={handleContactLink}
            className="bg-[#C9A84C] hover:bg-[#E8D08A] text-[#0C0C0C] font-sans text-xs font-bold tracking-widest uppercase py-3.5 px-6 transition-colors cursor-pointer"
            id="privacy-cta-btn"
          >
