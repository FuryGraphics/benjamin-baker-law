...
export default function ServiceAreaMap({ setRoute }: ServiceAreaMapProps) {
  ...
  return (
    <section 
      className="bg-[#0C0C0C] py-24 px-5 sm:px-6 lg:px-8 border-b border-[rgba(201,168,76,0.12)] relative"
    ...
    >
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        <div className="text-center mb-16">
          ...
          <h2 id="map-section-title" className="font-serif text-3xl sm:text-4xl lg:text-5xl text-[#F2EDE4] font-medium tracking-tight">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-stretch" id="map-grid-container">
          ...
          <div className="lg:col-span-7 flex flex-col justify-between" id="map-col-left">
            <div className="relative w-full h-[380px] sm:h-[450px] border border-[rgba(201,168,76,0.22)] rounded-sm overflow-hidden bg-[#141414] shadow-2xl">
              {/* Premium Grayscale Gradients & CSS Filter applied to IFrame for real dark map tiles */}
              <iframe 
            ...
            <div className="mt-4 flex flex-col sm:flex-row items-center justify-between gap-4 p-4 border border-[rgba(201,168,76,0.1)] bg-[#141414]/50 rounded-xs">
              <span className="font-sans text-xs text-[#888880] flex items-center gap-1.5">
              ...
              {setRoute && (
                <button 
                  ...
                  className="text-xs font-sans font-semibold text-[#C9A84C] hover:text-[#E8D08A] tracking-wider uppercase flex items-center gap-1 cursor-pointer"
          ...
          <div className="lg:col-span-12 xl:col-span-5 lg:col-start-8 bg-[#141414] border border-[rgba(201,168,76,0.18)] p-8 sm:p-10 flex flex-col justify-between shadow-2xl rounded-sm" id="map-col-right">
            <div className="space-y-8">
              ...
              <div className="space-y-4">
                ...
                <h3 className="font-serif text-2xl text-[#E8D08A] font-semibold tracking-wide">
                  Office Contact Information
                </h3>
                
                <div className="space-y-4 pt-4 text-xs sm:text-sm text-[#F2EDE4]/90 font-sans">
                  {/* Address */}
                  ...
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      ...
                      <a href="tel:9032717824" className="text-[#E8D08A] hover:text-[#C9A84C] hover:underline font-semibold leading-none">
                        (903) 271-7824
                      </a>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      ...
                      <a href="mailto:BenjaminABaker62@gmail.com" className="text-[#E8D08A] hover:text-[#C9A84C] hover:underline font-medium">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3" id="service-cities-checklist">
                  {serviceCitiesList.map((city, idx) => (
                    <button 
                      ...
                      className="flex items-center space-x-2 text-xs text-[#888880] hover:text-[#C9A84C] transition-colors text-left focus:outline-none cursor-pointer group"
                    >
            ...
            {/* CTA action bottom */}
            <div className="pt-8 border-t border-white/[0.04] mt-8 text-center sm:text-left">
              <span className="font-sans text-[11px] text-[#888880] block leading-relaxed">
